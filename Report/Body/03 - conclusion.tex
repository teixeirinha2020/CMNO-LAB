...
\par During the tuning phase, several iterations were performed to determine the optimal values for the controller weighting matrices. While various configurations were evaluated to refine the system response, the selected parameters provided a highly satisfying performance. Furthermore, these experimental results were found to be closely comparable with the numerical predictions, thereby validating the reliability of the simulation model and the robustness of the chosen coefficients.