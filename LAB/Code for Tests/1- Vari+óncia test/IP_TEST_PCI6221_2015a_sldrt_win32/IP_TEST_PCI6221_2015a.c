...
RT_MODEL_IP_TEST_PCI6221_2015a_T *IP_TEST_PCI6221_2015a(void)
{
  ...
  rtmSetTFinal(IP_TEST_PCI6221_2015a_M, 15.0);
  IP_TEST_PCI6221_2015a_M->Timing.stepSize0 = 0.01;
  IP_TEST_PCI6221_2015a_M->Timing.stepSize1 = 0.01;

  /* External mode info */
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[0] = (800813433U);
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[1] = (386898762U);
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[2] = (2027605432U);
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[3] = (1737770998U);
  ...
  IP_TEST_PCI6221_2015a_M->Sizes.numBlocks = (29);/* Number of blocks */
