...
%% 2. Definição do Vetor de Tempo
t = tout; 

%% 3. Criação da Figura
% Criamos a figura com um tamanho fixo
fig = figure('Name', 'Comparacao Sensor vs Estimador', 'Position', [100, 100, 800, 600]);

% --- Subplot 1: Motor Shaft Angle (Alpha) ---
subplot(2,1,1);
plot(t, alpha_sensor, 'b', 'LineWidth', 1.2); hold on;
plot(t, alpha_estimado, 'r--', 'LineWidth', 1.2); hold off;
...
subplot(2,1,2);
plot(t, beta_sensor, 'b', 'LineWidth', 1.2); hold on;
plot(t, beta_estimado, 'r--', 'LineWidth', 1.2); hold off;
